...
import { AppRegistry,label,input , Text, View, Image, StyleSheet, FlatList, Dimensions, TextInput } from 'react-native';
...
function Ayarlar({ navigation }) {
  ...
  <Icon name="save" size={25} color="#00A7FF" style={{alignSelf: 'flex-end', marginTop:5}}/></Card>
        ...
        <Card title="Kişisel Bilgiler">
          ...
          <TextInput
            placeholder="Gezi Tercihleriniz "
            style={{
              borderWidth: 1,
              paddingHorizontal: 20,
              paddingVertical: 0,
        ...
        <View style={{
          ...
          <Icon name="toggle-on" size={25} color="orange" 
          style={{
              paddingHorizontal: 20,
              paddingVertical: 0,
              flex:1,
        ...
        <View style={{ display: 'flex', flexDirection: 'row' }}>
          ...
          <View style={{ display: 'flex', flexDirection: 'row-reverse', flex: 1 }}>
            ...
            />
             ...
             <Button
              icon={<Icon name="info" size={35} color="orange" style={{ marginRight: 10 }} />}
              title="Yardım"
              buttonStyle={{ width: 150, margin: 15, color: "#000" }}
              type="outline"
            />
...
function AyarlarStack() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Ayarlar" component={Ayarlar} options={navigationOptionHandler} />
      <Stack.Screen name="Destek" component={Destek} options={navigationOptionHandler} />
    </Stack.Navigator>
  );
}
...
function eklebutonStack() {
  return (
    <Stack.Navigator>
      <Stack.Screen name="eklebuton" component={eklebuton} options={navigationOptionHandler} />
      <Stack.Screen name="Konum" component={Konum} options={navigationOptionHandler} />
    </Stack.Navigator>
  );
}
