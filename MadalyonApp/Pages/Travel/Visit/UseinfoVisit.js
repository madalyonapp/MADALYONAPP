...
@observer
export default class UseinfoVisit extends Component {
       state={
            city:Visit.city,
            contactno:Visit.contactno,
            hobby:Visit.hobby,
            sharecount:Visit.sharecounttravel,
            reliability:Visit.reliability,
            answerscount:Visit.answerscount,
            name:Visit.name,
            travel:Visit.travelchoise,
            mail:Visit.contactmail,
        };
    render() {
